...
class DobleLigadasVisualizer(tk.Toplevel):
    def __init__(self, parent, on_close):
        super().__init__(parent)
        self.title("Listas Doblemente Ligadas")
        ...
        self._build_ui()
        self.redibujar("Lista doble inicializada.")
